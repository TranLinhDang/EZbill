...
public class DBHandlerPower extends SQLiteOpenHelper {

    // creating a constant variables for our database.
    // below variable is for our database name.
    private static final String DB_NAME = "powerdbase";
    ...
    public DBHandlerPower(Context context) {
    ...
    public void addNewUsage(String userName, String userDate, String userPower) {
        ...
        values.put(POWER_COL, userPower);
