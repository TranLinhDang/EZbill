...
/**
 * Reference: https://github.com/kaviles/BLE_Tutorials
...
public class DeviceControlActivity extends Activity {
    ...
    private final String LIST_RW = "RW";
...
//                setPowerLevel(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            }
        }
    };
...
//                    Toast.makeText(name + " clicked");
                    ...
                    final String[] listItems1 = new String[]{"read", "cal"};
                    ...
                    if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) != 0) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                AlertDialog.Builder mBuilder = new AlertDialog.Builder(DeviceControlActivity.this);
                                mBuilder.setTitle("Chose an item");
                                mBuilder.setSingleChoiceItems(listItems, -1, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
//                                    mDataField.setText(listItems[i]);
//                                    if (mGattCharacteristics != null) {
//                                        final BluetoothGattCharacteristic characteristic =
//                                                mGattCharacteristics.get(groupPosition).get(childPosition);
//                                        final int charaProp = characteristic.getProperties();
...
//                                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) != 0) {
                                        if (listItems[i] == "low") {
                                            mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x10});
//                                            mDataField.setText("500");
                                        } else if (listItems[i] == "medium") {
                                            mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x11});
//                                            mDataField.setText("1000");
                                        } else if (listItems[i] == "high") {
                                            mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x12});
//                                            mDataField.setText("2000");
                                        }
...
//                    if(name == "00000010-1212-efde-1523-785fef13d123"){
...
//                                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) != 0) {
                                            if (listItems1[i] == "read") {
                                                mBluetoothLeService.readCharacteristic(characteristic);

//                                                mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x10});
//                                            mDataField.setText("500");
                                            } else if (listItems1[i] == "cal") {

                                                long endTime = SystemClock.elapsedRealtime();
                                                long elapsedMilliSeconds = endTime - startTime;
                                                double elapsedSeconds = elapsedMilliSeconds / 1000.0;
                                                String finalTime = Double.toString(elapsedSeconds);

                                                System.out.println("TIMEEEE:" + finalTime);


                                                String a = mDataField.getText().toString();
                                                System.out.println("Str:" + a);
//
                                                Intent i1 = new Intent(getApplicationContext(), PowerLevel.class);

                                                i1.putExtra("powerlevel", a);
                                                i1.putExtra("elapsed time", finalTime);
                                                startActivity(i1);
                                            }
//                                                mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x11});
//                                            mDataField.setText("1000");
//                                            } else if (listItems1[i] == "high") {
////                                                mBluetoothLeService.writeCharacteristic(characteristic, new byte[]{(byte) 0x12});
////                                            mDataField.setText("2000");
//                                            }
                                            dialogInterface.dismiss();
...
//                            mBluetoothLeService.passValue(characteristic);

//                            String a = mDataField.getText().toString();
//
//                            Intent i = new Intent(getApplicationContext(), PowerLevel.class);
//                            i.putExtra("powerlevel", a);
//                            startActivity(i);
                        }
//                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_READ) != 0) {
...
//                            startActivity(intent);
                ...
                if(item.getItemId() == R.id.nav_character){
                    Intent intent = new Intent(getApplicationContext(), DashBoadActivity.class);
//                    intent.putExtra("power_message", intent.getStringExtra(powerLevel) );
                    startActivity(intent);
                }
    ...
    public void setPowerLevel(String data){
        powerLevel = data;
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                currentCharaData.put(LIST_RW, rw);
